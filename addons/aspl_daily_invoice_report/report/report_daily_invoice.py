...
class report_daily_invoice(models.AbstractModel):
    ...
    def _query(self, obj):
        ...
        SQL = """SELECT ai.date_invoice as date,
                ai.number as number, ai.team_id, ai.id, ai.residual as residual, rp.ref as ref, ai.date_due as date_due,
                (ai.amount_total) as product_amt,
                (ai.amount_total) as inv_total,
                rp.id as partner_id
