...
class dev_stock_inventory(models.TransientModel):
    ...
    #     sql_query = """select sum(sq.qty) from stock_quant as sq \
    #                      where sq.location_id in %s \
    #                      and sq.product_id = %s and sq.in_date < %s and sq.company_id = %s
    #                      """
    #     start_date = str(self.start_date) + ' 00:00:00'
    #     params = (tuple(sq_location_ids), product.id,start_date,self.company_id.id)
    ...
    def get_receive_qty(self, product, warehouse_id):
        ...
        start_date = str(self.start_date)+ ' 00:00:00'
        end_date = str(self.end_date) + ' 00:00:00'
    ...
    @api.multi
    def print_pdf(self):
        return self.env['report'].get_action(self, 'dev_stock_inventory_report.stock_inventory_template')
    ...
    def export_stock_ledger(self):
        ...
        for warehouse_id in self.warehouse_ids:
            ...
            tags = ['Internal Reference','Barcode','Beginning', 'Received', 'Sales', 'Internal', 'Adjustments', 'Ending']
            ...
            if not self.is_group_by_category:
                ...
                for line in lines:
                    ...
                    c=4
                    worksheet[work].write(r, c, line.get('default_code'), text_left)
                    c+=1
                    worksheet[work].write(r, c, line.get('barcode'), text_left)
                    c+=1
                ...
                c = 4
                worksheet[work].write(r, c,' ' , text_right_bold1)
                c += 1
                worksheet[work].write(r, c, ' ', text_right_bold1)
                c += 1
                ...
                r = 9
                for l_val in lines:
                    worksheet[work].write_merge(r, r, 0, 11, l_val.get('category'), group_style)
                    r+=1
                    b_qty = r_qty = s_qty = i_qty = a_qty = e_qty =0
