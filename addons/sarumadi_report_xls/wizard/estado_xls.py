...
class EstadoPagoXLSWizard(models.Model):

    _name = 'estado.xls.popup'
    ...
    state = fields.Selection([('choose', 'choose'), ('get', 'get')],
                             default='choose')
    report = fields.Binary('Descargar', filters='.xls', readonly=True)
    ...
    def generate_xls_report(self):
        ...
        for invoice in invoices:
            ...
            ws1.write(row,col+3,invoice.partner_id.payment_term_id,line_content_style)
